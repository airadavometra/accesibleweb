...
export const categories: Category[] = [
  {
    imgSrc: "/fruits.png",
    title: "Fruits",
    path: "/tremor/accessible/category?category=fruits",
  },
  {
    imgSrc: "/vegetables.png",
    title: "Vegetables",
    path: "/tremor/accessible/category?category=vegetables",
  },
  {
    imgSrc: "/combos.png",
    title: "Combo",
    path: "/tremor/accessible/category?category=combo",
  },
];
...
const ChallengeHome = () => {
  return (
    <main className={s.main}>
      <Hero path="tremor" />
      <Bestsellers products={bestsetters} path="tremor" />
      <Banner
        imgSrc="/salad.png"
      ...
      />
      {dayOffer && <DayOffer product={dayOffer} path="tremor" />}
    </main>
  );
};
