...
export const categories: Category[] = [
  {
    imgSrc: "/fruits.png",
    title: "Fruits",
    path: "/dyslexia/accessible/category?category=fruits",
  },
  {
    imgSrc: "/vegetables.png",
    title: "Vegetables",
    path: "/dyslexia/accessible/category?category=vegetables",
  },
  {
    imgSrc: "/combos.png",
    title: "Combo",
    path: "/dyslexia/accessible/category?category=combo",
  },
];
...
const ChallengeHome = () => {
  return (
    <main className={s.main}>
      <Hero path="dyslexia" />
      <Bestsellers products={bestsetters} path="dyslexia" />
      <Banner
        imgSrc="/salad.png"
      ...
      />
      {dayOffer && <DayOffer product={dayOffer} path="dyslexia" />}
    </main>
  );
};
