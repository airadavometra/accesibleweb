...
import s from "@/styles/simulation/dyslexia/Cart.module.css";
import WidthContainer from "@/components/common/WidthContainer/WidthContainer";
import { useSimulationStore } from "@/state/useSimulation";
import { EmptyState } from "@/components/dyslexiaSimulation/EmptyState/EmptyState";
import Image from "next/image";
import { QuantityButton } from "@/components/dyslexiaSimulation/QuantityButton/QuantityButton";
import { Button } from "@/components/dyslexiaSimulation/Button/Button";
        ...
        {cart.length === 0 ? (
          ...
          <>
            <div className={s.titleContainer}>
              ...
              <Link href="/dyslexia" className={s.continueShoppingLink}>
                Continue shopping
              </Link>
            </div>
            {isMobile ? (
