...
import s from "@/styles/simulation/accessible/Cart.module.css";
import WidthContainer from "@/components/common/WidthContainer/WidthContainer";
import { useSimulationStore } from "@/state/useSimulation";
import { EmptyState } from "@/components/accessible/EmptyState/EmptyState";
import Link from "next/link";
import Image from "next/image";
import { QuantityButton } from "@/components/accessible/QuantityButton/QuantityButton";
  ...
  return (
    <main className={s.main}>
      <WidthContainer className={s.widthContainer}>
        {cart.length === 0 ? (
          <EmptyState text="Your cart is empty" path="color-blindness" />
        ) : (
          <>
            <div className={s.titleContainer}>
              <h1 className={s.title}>Your cart</h1>
              <Link
                href="/color-blindness/accessible"
            ...
            <section className={s.subtotalContainer}>
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  router.push("/color-blindness/accessible/checkout");
                }}
              />
            </section>
          </>
