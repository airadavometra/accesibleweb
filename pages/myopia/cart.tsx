...
import { QuantityButton } from "@/components/myopiaSimulation/QuantityButton/QuantityButton";
        ...
        {cart.length === 0 ? (
          ...
          <>
            <div className={s.titleContainer}>
              ...
              <Link href="/myopia" className={s.continueShoppingLink}>
                Continue shopping
              </Link>
            </div>
            {isMobile ? (
