...
export const categories: Category[] = [
  {
    imgSrc: "/fruits.png",
    title: "Fruits",
    path: "/myopia/accessible/category?category=fruits",
  },
  {
    imgSrc: "/vegetables.png",
    title: "Vegetables",
    path: "/myopia/accessible/category?category=vegetables",
  },
  {
    imgSrc: "/combos.png",
    title: "Combo",
    path: "/myopia/accessible/category?category=combo",
  },
];
...
const ChallengeHome = () => {
  ...
  return (
    <main className={s.main}>
      <Hero path="myopia" />
      <Bestsellers products={bestsetters} path="myopia" />
      <Banner
        imgSrc="/salad.png"
      ...
      />
      {dayOffer && <DayOffer product={dayOffer} path="myopia" />}
    </main>
  );
};
